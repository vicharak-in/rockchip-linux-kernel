...
static int ws_panel_get_modes(struct drm_panel *panel, struct drm_connector *connector)
{
			  ...
			  const struct i2c_device_id *id)
{
	...
	ts->base.dev = dev;
	drm_panel_init(&ts->base, ts->base.dev, ts->base.funcs, ts->base.connector_type);
