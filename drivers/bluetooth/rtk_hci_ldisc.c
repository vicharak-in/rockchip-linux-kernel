...
int rtk_hci_uart_register_proto(struct hci_uart_proto *p)
{
...
int rtk_hci_uart_unregister_proto(struct hci_uart_proto *p)
{
	if (p->id >= HCI_UART_MAX_PROTO)
		return -EINVAL;
...
int rtk_hci_uart_tx_wakeup(struct hci_uart *hu)
{
